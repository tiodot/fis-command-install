...
exports.name = 'install-npm';
exports.usage = '[options] <components...>';
exports.desc = 'install-npm components';
...
function getComponentsFromFile(fileName, settings) {
    var components = settings.components;
    var path = require('path');
    ...
    if (exists(componentJson)) {
        ...
        return config(componentJson)
            ...
            .then(function (ret) {
                settings.config = ret;
                [].push.apply(settings.components, ret.dependencies || []);

                [].push.apply(settings.components, ret.devDependencies || []);

                if (fileName === 'package.json') {
                    settings.protocol = 'npm';
                }
